        ...
        <div class="card-body">
            <form action="{{route('layanan.update', $layanan)}}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="jenis_layanan_id" id="jenis_layanan_id" class="form-control">
                        ...
                        @foreach ($jenis_layanan as $item)
                            <option {{$item->id==$layanan->jenis_layanan_id?'selected':''}} value="{{ $item->id }}">{{$item->nama}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="deskripsi" class="form-control" id="deskripsi" value="{{ $layanan->deskripsi }}" required>
                </div>
